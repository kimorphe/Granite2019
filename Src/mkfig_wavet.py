...
if __name__=="__main__":
    ...
    imb0=bx[0].imshow(S*mV,extent=ext2,interpolation="bilinear",aspect="auto",cmap="jet",vmin=Vmin/1.5,vmax=Vmax/1.5,origin="lower")
    ...
    imb1=bx[1].imshow(bndl.amp[indx,:,:]*mV,extent=ext2,interpolation="bilinear",aspect="auto",cmap="jet",vmin=Vmin/1.5,vmax=Vmax/1.5,origin="lower")
